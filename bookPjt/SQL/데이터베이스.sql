...
/*Table structure for table `adminanswar` */

DROP TABLE IF EXISTS `adminanswar`;

CREATE TABLE `adminanswar` (
...
/*Data for the table `adminanswar` */
...
(19,'노인과 바다',3,'이재용','ㅇㄹㅇㄹ','\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\21.jpg',0,'2019-11-18 12:20:24'),
