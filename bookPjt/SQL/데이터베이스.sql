...
(21, '개를 안다고 생각했는데', 3, '홍수지', '노석미 신작 에세이, 어쩌면 나의 40대에 대한 이야기. 보고 느끼고 쓰고 그리는 삶. 이런 일상의 반복에 있어서의 꾸준함이라는 태도. 작가는 매일같이 그 뼈대를 곧추세우고 매일같이 그 뼈대에 붙은 살을 근육으로 단련시키고자 마음을 쓰듯 몸을 쓰는 작가이다. 이 책은 그 과정의 아주 솔직하고도 담백한 어떤 일기이다.', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\k592636099_1.jpg', 0, '2019-11-27 10:38:17'),
...
(22, '여행의 이유', 2, '김영하', '히가시노 게이고 필력의 진수를 엿볼 수 있는 단편집이다. 교통 법규 위반이라는 일상적인 범죄에 그만이 낼 수 있는 독특한 상상력을 녹여 내어 시대를 초월해 공감을 불러일으키는 시리즈로 탄생시켰다.\r\n', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\k842534785_1.jpg', 0, '2019-12-03 18:00:27'),
...
(24, '복수해 기억해', 3, '섀넌커크', '열여섯 살 소녀 리사가 납치되었다. 눈이 가려진 채 외딴 건물로 끌려가 감금되었지만 리사는 공포에 질리는 대신 자신의 위치를 가늠한다. 입속으로 ‘미시시피’를 602번 외었으니 도로에서 건물까지 10.2분 거리, 계단을 세 줄 올라왔으니 3층…. 소시오패스로 오해받을 정도로 냉정하고 침착한 리사는 연필깎이, 뜨개바늘, 니트 담요 등 주변의 물건을 무기 삼아 작전을 짠다. 납치범을 응징할 리사의 무자비한 작전은 성공할 수 있을까?', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\qhrtn.jpg', 0, '2019-12-03 18:02:41'),
(25, '여덟 가지 삶의 태도', 5, '나폴레온 힐', '수많은 히트 광고를 제작한 이채훈 제일기획 크리에이티브 디렉터의 첫 책이다. 그는 탁월한 아이디어는 하늘에서 내려오는 것도, 천재적인 재능도 아닌, 좋은 습관을 꾸준히 실천하는 데서 나온다고 단언한다. 타고난 재능을 이기는 힘은 매일 조금씩 쓰고, 말하고, 달리는 꾸준함에서 나온다는 것이다. 밀도 있는 작업 현장에서 건져올린 초히트 아웃풋의 비결을 만나보자!', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\8954639771_1.jpg', 0, '2019-12-03 18:04:52'),
(26, '꿈꾸는 책들의 도시', 2, '강진원', '작품 속 주인공 루시 플라이는 지진 새가 울던 날 오후, 또 다른 영국 여자 릴리 브리지스를 살해한 혐의로 일본 경찰에 체포된다. 그리고 루시의 개인적 독백, 즉 (남성) 경찰관에게 취조당하는 걸 거부하는 한 여자의 이야기가 이어지며 작품 초반부터 긴장감을 완벽하게 조성해나간다.\r\n', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\8954658121_1.jpg', 0, '2019-12-03 18:06:04'),
(27, '과거에서 온 여자', 5, '진행선', '내가 아는 한 릴리의 죽음에 관해 밝혀진 사실은 거의 없고, 있다 하더라도 오해의 소지가 다분하다. 릴리는 어느 날 밤, 소리 소문도 없이 사라졌다. 도쿄에 머문 지 몇 달밖에 되지 않았을 때였다. 그리고 며칠 후, 도쿄 만에서 젊은 여성의 몸통 하나와 절단된 사지 두 토막이 떠올랐다. 팔이었는지 다리였는지는 기억나지 않지만, 후에 몸통과 일치하는 것으로 밝혀졌다. 손이 없어서 지문도 채취할 수 없었기에 경찰은 공식적으로 신원을 밝힐 수 없었다. 하지만 시체는 릴리의 것이라고 널리 받아들여지는 듯했다.', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\8954655971_2.jpg', 0, '2019-12-03 18:07:06'),
(28, '배신의 대가', 6, '이인호', '내가 이야기를 채 끝내기도 전에 데이지는 잠들어 있었다. 사실 그는 내가 이야기를 시작한 직후 잠들었다. 나는 알고 있었지만, 내 이야기가 그에게 좋은 자장가가 되어주었기에 멈추지 않았다. 나는 그가 잠든 것이 무례하다고 생각하지 않았다. ', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\k072636585_1.jpg', 12, '2019-12-03 18:08:11'),
(29, '무죄와 유죄의 차이', 3, '김한석', '수재나 존스는 간결하지만 인상적인 문체로 내내 으스스한 모호함을 유지해감으로써 긴장감 지진계의 진도 10을 기록한다. 강렬하게 뇌리를 떠나지 않는, 매우 세심하게 창작된 이 데뷔 소설의 진동은 마지막 장이 넘어가고 한참 후까지도 계속해서 느껴진다.', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\896782095x_1.jpg', 0, '2019-12-03 18:09:09'),
(30, '고도에서', 2, '스티븐 킹', '스콧에겐 한 가지 비밀이 있다. 외형은 그대로지만 몸무게가 매일 0.5kg씩 줄어들고 있는 것. 게다가 무거운 물건을 들고 체중계에 오르면 무게가 더해져야 할텐데 그렇지 않다. 마치 무중량 상태에 있는 우주 비행사의 몸처럼 변하는 중이다. 절친한 의사인 밥에게 찾아가 보지만, 초자연적인 현상 앞에서 그도 어쩔 도리가 없다. 혼돈 속에서 스콧은 생각한다.', '\\source\\repos\\bookPjt\\bookPjt\\Resources\\BookImg\\k902636691_1.jpg', 0, '2019-12-03 18:10:09');
...
(14, 1, 19, '2019-11-15', '2019-11-17', 0, 0),
(15, 2, 26, '2019-12-03', '2019-12-10', 0, 0);
...
(1, '삼재용', '010', '4228', '5921', 'dlwodyd202', '1234', '9507172', 'B'),
...
('사용자 이용 약관입니다.', '연체시 1일당 100원의 비용을 부담해야합니다.\r\n대출할 도서를 선택하여 대출신청 해주세요', '2019-11-27', 0, 7),
('도서관 휴일', '저희 도서관은 이번 크리스마스와 크리스마스 이브에 휴관합니다. (2019년 12월 24,25)', '2019-12-03', 0, 8);
...
(3, '도서가 손상되었을때', '제가 빌려간 책이 손상되었습니다. 도서관에 어느부서에 말씀드려야 할까요?', '2019-12-03', 0, 2),
(4, '오래된책 기부', '제가 소장하고있던 책을 기부하려합니다. 기부하는 방법을 알려주세요', '2019-12-03', 1, 2),
(5, '도서관 조사를 하고싶습니다.', '과제로 사서분과 인터뷰를 해야합니다. 누구를 찾아가야하나요?', '2019-12-03', 0, 2);
